...
# Version identifier - used in HTML to identify main version
if 'dev' in release:
    release = 'dev'
print(release, version)

# Multiversion configuration
# Use the super project (vispy) instead of (vispy-website)
smv_use_git_super_project = True
# only include the master branch (should be renamed to 'dev' in HTML)
smv_branch_whitelist = r'^master$'
# only include tags starting with v
smv_tag_whitelist = r'^v\d+\.\d+\.\d+$'
# use origin and upstream remotes, not local branches/tags
smv_remote_whitelist = r'^(origin|upstream)$'
# identify releases if they are tags
smv_released_pattern = r'^tags/.*$'
# prefer remote refs over local
#smv_prefer_remote_refs = True
# output to a 'versions/' base directory and
# use this config's 'release' variable as a subdir
...
html_sidebars = {'documentation*': ['versioning.html', 'localtoc.html', 'searchbox.html'],
